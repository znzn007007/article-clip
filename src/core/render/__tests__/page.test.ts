...
describe('PageRenderer', () => {
  ...
  describe('handleTwitter', () => {
    it('should stop when reaching maxTweets', async () => {
      ...
      // Should have called evaluate 3 times (scrolls only, no scroll to top)
    ...
    it('should stop after 3 unchanged scrolls', async () => {
      ...
      // Should have called evaluate 4 times (scrolls only, no scroll to top)
    ...
    it('should reset unchangedCount when new tweets load', async () => {
      ...
      // Evaluate calls: 6 scrolls only (no scroll to top)
